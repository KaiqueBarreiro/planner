...
export default function Trip() {
    ...
    async function getTripDetails() {
        try {
            ...
            const destination = trip.destination.length > 14 
    ...
    return (<View className="flex-1 px-5 pt-16">
        ...
        <Modal title="Atualizar viagem" subtitle="Somente quem criou a viagem pode editar." visible={showModal === MODAL.UPDATE_TRIP} onClose={() => setShowModal(MODAL.NONE)}>
            <View className="gap-2 my-4">
                ...
                <Input variant="secondary">
                    ...
                    <Input.Field placeholder="Quando?" value={selectedDates.formatDatesInText} onPressIn={() => setShowModal(MODAL.CALENDAR)} onFocus={() => Keyboard.dismiss()}/>
                </Input>
        ...
        <Modal title="Selecionar datas" subtitle="Selecione a data de ida e volta da viagem" visible={showModal === MODAL.CALENDAR} onClose={()=> setShowModal(MODAL.UPDATE_TRIP)}>
            <View className="gap-4 mt-4">
                <Calendar minDate={dayjs().toISOString()} onDayPress={handleSelectedDate} markedDates={selectedDates.dates}></Calendar>
        ...
        <Modal title="Confirmar presença" visible={showModal === MODAL.CONFIRM_ATTENDANCE}>
            <View className="gap-4 mt-4">
                <Text className="text-zinc-400 font-regular leading-6 my-2">
                    ...
                    Para confimar sua presença na viagem, preencha os dados abaixo:
                </Text>
                ...
                <Input variant="secondary">
                    ...
                    <Input.Field placeholder="E-mail de confirmação" onChangeText={setGuestEmail} value={guestEmail}/>
                </Input>
