...
export default function Index () {
    ...
    function handleNextStepForm () {
        ...
        if ( destination.length < 4 ) {
            return Alert.alert("Detalhes da viagem", "O destinto deve ter pelo menos 4 caracteres.")
        }
    ...
    return (
        <View className="flex-1 items-center justify-center px-5"> 
            ...
            <Text className="text-zinc-500 font-regular text-center text-base">
                Ao planejar sua viagem pela plann.er você automaticamente com nossos {" "}<Text className="text-zinc-300 underline">termos de uso e políticas de privacidade.</Text>
            </Text>
            ...
            <Modal 
                ...
                subtitle="Os convidados irá receber e-mails para confirmar a participação na viagem." 
